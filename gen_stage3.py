...
def draw_cover():
    ...
    # Stage-5 foreshadow: how the record draws pictures with sound
    d.text((x0, 244), "PICTURES ARE DRAWN IN LINES:", font=f(17), fill=170)
    d.text((x0, 268), "512 lines  /  8 ms each  /  top to bottom",
           font=f(17, bold=True), fill=230)
    d.text((x0, 300), "a circle proves your timing", font=f(16), fill=160)
