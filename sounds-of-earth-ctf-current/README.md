...
| 5 | Sounds of Betelgeuse | Radio / image (SSTV) | SSTV file / on-air | `flag{we_are_the_signal_we_sent}` |

All five stages are built and verified.
...
- **S5:** `pysstv` to encode; any SSTV decoder (phone app or CLI) to verify.
