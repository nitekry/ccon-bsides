...
- **Feeds forward:** decrypted message carries the Stage-5 pointer + scan-line spec
...
> DRAW WITH SOUND. WE KEPT THE 116TH PICTURE. `flag{hydrogen_line_handshake}` FIND
> IT: 512 LINES, 8 MS EACH, TOP TO BOTTOM. A CIRCLE PROVES YOUR TIMING.
